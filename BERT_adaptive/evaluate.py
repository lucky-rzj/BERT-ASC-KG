...
from MyModel_adaptive import BERT_ASC_adaptive
...
def main():
    ...
    #parser.add_argument('--pt_model', default='activebus/BERT-PT_rest', type=str)    #预训练模型名称
    ...
    opt.inputs_cols = ['text_bert_indices', 'bert_segments_ids', 'input_mask', 'label']   #配置模型输入列名
